...
function SideNav() {
  return (
    <aside className="sticky top-0 z-20 h-screen border-r border-[var(--oc-hairline)] bg-[var(--oc-canvas-deep)] p-4 text-[var(--oc-ink)] max-[1120px]:static max-[1120px]:h-auto max-[1120px]:border-b max-[1120px]:border-r-0 max-[1120px]:p-3">
      <div className="grid grid-cols-[48px_minmax(0,1fr)] items-center gap-3 border border-[var(--oc-hairline)] bg-[var(--oc-surface)] p-3 max-[760px]:grid-cols-[42px_minmax(0,1fr)]">
        <span className="grid h-10 w-12 place-items-center rounded-[4px] border border-[var(--oc-hairline-strong)] bg-[var(--oc-surface-soft)] text-xs font-bold leading-none text-[var(--oc-marker)] max-[760px]:h-9 max-[760px]:w-[42px]">[LL]</span>
