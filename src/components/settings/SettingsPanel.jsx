...
export function SettingsPanel({ onClose }) {
  ...
  return (
    <div className={ui.modalOverlay} role="presentation" onMouseDown={onClose}>
      <section
        className="max-h-[min(820px,calc(100vh-40px))] w-[min(760px,100%)] overflow-auto border border-[var(--oc-hairline-strong)] bg-[var(--oc-canvas)] text-[var(--oc-ink)] motion-safe:animate-[modalIn_var(--transition-base)_both]"
        role="dialog"
        aria-modal="true"
      ...
      >
        <header className="relative border-b border-[var(--oc-hairline)] p-4 pr-16">
          ...
          <h2 id="settings-title" className={ui.sectionTitle}>Keyboard shortcuts</h2>
          <Button
            type="button"
            variant="soft"
