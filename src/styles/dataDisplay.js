export const dataDisplayStyles = {
  ...
  pillMarked: "inline-flex min-h-7 w-fit items-center whitespace-nowrap rounded-[4px] border border-[var(--oc-hairline-strong)] bg-transparent px-2 py-1 text-xs font-medium uppercase leading-normal text-[var(--oc-muted)] oc-x-before",
  pill: "inline-flex min-h-7 w-fit items-center whitespace-nowrap rounded-[4px] border border-[var(--oc-hairline-strong)] bg-transparent px-2 py-1 text-xs font-medium uppercase leading-normal text-[var(--oc-muted)]",
  ...
  ratingPill: "inline-flex min-h-8 w-full items-center justify-between gap-3 rounded-[4px] border border-[var(--oc-hairline)] bg-[var(--oc-surface)] px-3 py-1.5 text-xs uppercase leading-normal text-[var(--oc-muted)]",
  ratingLabel: "truncate font-bold",
  ratingValue: "shrink-0 text-[var(--oc-ink)]",
