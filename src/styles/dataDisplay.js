export const dataDisplayStyles = {
  ...
  metricCard: "flex min-h-[136px] min-w-0 flex-col gap-2 border border-[var(--oc-hairline)] bg-[var(--oc-surface)] p-6 text-[var(--oc-ink)] max-[760px]:min-h-[120px] max-[760px]:p-4",
