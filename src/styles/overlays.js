export const overlayStyles = {
  ...
  confirmationPanel: "w-[min(460px,100%)] border border-[var(--oc-hairline)] bg-[var(--oc-canvas)] p-5 text-[var(--oc-ink)] motion-safe:animate-[modalIn_var(--transition-base)_both] max-[520px]:p-4",
