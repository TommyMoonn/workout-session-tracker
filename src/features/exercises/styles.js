...
export const exerciseStyles = {
  ...
  exerciseRow: "oc-interactive grid w-full grid-cols-[minmax(0,1fr)_auto] items-center gap-3 border-0 border-b border-l-[3px] border-[var(--oc-hairline)] border-l-transparent bg-transparent px-4 py-3.5 text-left text-[var(--oc-body)] hover:bg-[var(--oc-surface-soft)] hover:text-[var(--oc-ink)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-[var(--oc-focus)] max-[760px]:gap-2 max-[760px]:px-3 max-[760px]:py-3 [contain:layout_paint_style] [content-visibility:auto] [contain-intrinsic-size:96px]",
  ...
  exerciseDetailContentIn: "oc-content-swap",
  ...
  videoFrame: "relative mt-4 aspect-video overflow-hidden border border-[var(--oc-hairline-strong)] bg-[var(--oc-media-surface)] [&_iframe]:h-full [&_iframe]:w-full [&_iframe]:border-0",
  videoEmbed: "h-full w-full border-0 motion-safe:animate-[overlayIn_var(--motion-duration-base)_var(--motion-ease-enter)_both]",
